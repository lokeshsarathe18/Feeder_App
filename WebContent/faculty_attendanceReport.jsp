...
<body>
	...
	<div style="margin-left: 30%">
		<span style="color: red; font-weight: bold; font-size: 20px;">Attendance
			Between Dates</span>
		<form method="post" action="faculty_attendanceReport.jsp">
			<%
			...
			%>
			<input required="required" autocomplete="off" placeholder="From Date" type="text"
				name="fdate" id="fdate" /> 
				<input required="required" autocomplete="off" placeholder="To Date" type="text" name="tdate" id="tdate" />
			<%
				}
			%>
